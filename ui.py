...
from PyQt6.QtGui import (
    ...
    QFontDatabase, QFontMetrics, QKeySequence, QLinearGradient, QPainter, QPainterPath,
...
# Typeface and size, in one place. Courier New at 7-8 pt was the main source of
# eye strain: a thin face at a size below comfortable reading. Every QFont in
# this file goes through _MONO and _pt(), so the whole UI can be retuned here.
_MONO = ("Menlo" if sys.platform == "darwin"
...
def _pt(size: int) -> int:
    return max(6, round(size * _FONT_SCALE))
...
class HudCanvas(QWidget):
    ...
    def _paint_core(self, p: QPainter, cx: float, cy: float, r: float,
        ...
        if name:
            ...
            f = QFont(_MONO, fsz, QFont.Weight.Bold)
    ...
    def paintEvent(self, _):
        ...
        p.setPen(QPen(col, 1))
        p.setFont(QFont(_MONO, _pt(11), QFont.Weight.Bold))
...
class MetricBar(QWidget):
    ...
    def paintEvent(self, _):
        ...
        p.setFont(QFont(_MONO, _pt(7), QFont.Weight.Bold))
        p.setPen(QPen(qcol(C.TEXT_DIM), 1))
        p.drawText(QRectF(8, 5, 50, 14), Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter, self._label)

        p.setFont(QFont(_MONO, _pt(9), QFont.Weight.Bold))
...
class LogWidget(QTextEdit):
    ...
    def __init__(self, parent=None):
        ...
        self.setFont(QFont(_MONO, _pt(9)))
...
class _DropCanvas(QWidget):
    ...
    def _paint_idle(self, p, W, H, hover):
        ...
        p.setFont(QFont(_MONO, _pt(8)))
        p.setPen(QPen(qcol(C.PRI_DIM if not hover else C.TEXT), 1))
        p.drawText(QRectF(0, cy + 8, W, 16), Qt.AlignmentFlag.AlignCenter,
                   "Drop file here  or  Click to Browse")
        tipos = "Images · Video · Audio · PDF · Docs · Code · Data"
        f = QFont(_MONO, _pt(7))
        # Shrink to fit: at the larger UI size this list is wider than the drop
        # zone and was clipped at both edges.
        while f.pointSize() > 6 and QFontMetrics(f).horizontalAdvance(tipos) > W - 16:
            f.setPointSize(f.pointSize() - 1)
        p.setFont(f)
        p.setPen(QPen(qcol(C.TEXT_DIM), 1))
        p.drawText(QRectF(0, cy + 24, W, 18), Qt.AlignmentFlag.AlignCenter, tipos)

    def _paint_drag_over(self, p, W, H):
        cx, cy = W / 2, H / 2
        p.setFont(QFont(_MONO, _pt(20)))
        p.setPen(QPen(qcol(C.PRI), 1))
        p.drawText(QRectF(0, cy - 24, W, 32), Qt.AlignmentFlag.AlignCenter, "⬇")
        p.setFont(QFont(_MONO, _pt(8), QFont.Weight.Bold))
        p.setPen(QPen(qcol(C.PRI), 1))
    ...
    def _paint_file(self, p, W, H):
        ...
        p.setFont(QFont(_MONO, _pt(7)))
        p.setPen(QPen(qcol(C.TEXT_DIM), 1))
        p.drawText(QRectF(tx, H * 0.18 + 18, tw, 14),
                   Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter,
                   f"{ext_str}  ·  {size_str}")

        p.setFont(QFont(_MONO, _pt(6)))
...
class _CameraPreview(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        title.setFont(QFont(_MONO, _pt(7), QFont.Weight.Bold))
        title.setStyleSheet(f"color: {C.PRI}; background: transparent;")
        hdr.addWidget(title)
        hdr.addStretch()
        close_btn = QPushButton("✕")
        close_btn.setFixedSize(16, 16)
        close_btn.setFont(QFont(_MONO, _pt(8)))
...
class SetupOverlay(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        def _lbl(txt, font_size=9, bold=False, color=C.PRI,
            ...
            w.setFont(QFont(_MONO, _pt(font_size),
        ...
        self._key_input.setFont(QFont(_MONO, _pt(10)))
        ...
        for key, label in [("windows","⊞  Windows"),("mac","  macOS"),("linux","🐧  Linux")]:
            ...
            btn.setFont(QFont(_MONO, _pt(9), QFont.Weight.Bold))
        ...
        init_btn.setFont(QFont(_MONO, _pt(10), QFont.Weight.Bold))
...
class CustomizeOverlay(QWidget):
    ...
    def __init__(self, assistant_name="JARVIS", user_name="",
        ...
        self._name_input.setFont(QFont(_MONO, _pt(10)))
        ...
        self._user_input.setFont(QFont(_MONO, _pt(10)))
        ...
        for _v in AVAILABLE_VOICES:
            ...
            b.setCheckable(True)
            b.setFixedHeight(28)
            b.setFont(QFont(_MONO, _pt(8), QFont.Weight.Bold))
        ...
        df_btn.setFont(QFont(_MONO, _pt(7), QFont.Weight.Bold))
        ...
        self._hex_input.setFont(QFont(_MONO, _pt(10)))
        ...
        save_btn.setFont(QFont(_MONO, _pt(9), QFont.Weight.Bold))
        ...
        cancel_btn.setFont(QFont(_MONO, _pt(9)))
...
class PluginManagerOverlay(QWidget):
    ...
    def __init__(self, plugins: list[dict], parent=None):
        ...
        hdr.setFont(QFont(_MONO, _pt(12), QFont.Weight.Bold))
        ...
        if not plugins:
            ...
            empty.setFont(QFont(_MONO, _pt(8)))
        ...
        close_btn.setFont(QFont(_MONO, _pt(9)))
        close_btn.setCursor(Qt.CursorShape.PointingHandCursor)
    ...
    def _build_row(self, p: dict) -> QHBoxLayout:
        ...
        btn.setFont(QFont(_MONO, _pt(7), QFont.Weight.Bold))
        if not p["valid"]:
            btn.setText("BROKEN")
...
class ConfirmBanner(_HudOverlay):
    ...
    def __init__(self, title: str, detail: str, parent=None):
        ...
        hdr = QLabel("⚠  CONFIRM")
        hdr.setFont(QFont(_MONO, _pt(11), QFont.Weight.Bold))
        hdr.setStyleSheet(f"color: {C.ACC}; background: transparent;")
        lay.addWidget(hdr)

        ttl = QLabel(title)
        ttl.setWordWrap(True)
        ttl.setFont(QFont(_MONO, _pt(10), QFont.Weight.Bold))
        ...
        yes.setFont(QFont(_MONO, _pt(9), QFont.Weight.Bold))
...
class AudioDeviceOverlay(_HudOverlay):
    ...
    def __init__(self, parent=None):
        ...
        note.setFont(QFont(_MONO, _pt(7)))
        ...
        ok.setFont(QFont(_MONO, _pt(9), QFont.Weight.Bold))
        ...
        cancel.setFont(QFont(_MONO, _pt(9)))
...
class MemoryOverlay(_HudOverlay):
    ...
    def _rebuild(self):
        ...
        cap.setFont(QFont(_MONO, _pt(7)))
        cap.setStyleSheet(f"color: {C.TEXT_DIM}; background: transparent;")
        self._lay.addWidget(cap)

        if not rows:
            empty = QLabel("Nothing stored yet.")
            empty.setFont(QFont(_MONO, _pt(9)))
        ...
        close.setFont(QFont(_MONO, _pt(9)))
...
class ClipboardPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        icon_lbl.setFont(QFont(_MONO, _pt(7), QFont.Weight.Bold))
        icon_lbl.setStyleSheet(f"color: {C.ACC2}; background: transparent;")
        hdr.addWidget(icon_lbl); hdr.addStretch()
        x_btn = QPushButton("✕")
        x_btn.setFixedSize(16, 16)
        x_btn.setFont(QFont(_MONO, _pt(8)))
        ...
        self._preview.setFont(QFont(_MONO, _pt(8)))
        ...
        for label, cmd_fmt in [
            ...
            b = QPushButton(label)
            b.setFixedHeight(22)
            b.setFont(QFont(_MONO, _pt(7), QFont.Weight.Bold))
            b.setCursor(Qt.CursorShape.PointingHandCursor)
            b.setStyleSheet(_bs)
    ...
    def _build_section(self, form: QVBoxLayout, sec: dict):
        ...
        for field in fields:
            ...
            if ftype == "choice":
                ...
                w.setFixedHeight(28)
                w.setFont(QFont(_MONO, _pt(8), QFont.Weight.Bold))
        ...
        if isinstance(action, dict) and callable(action.get("run")):
            ...
            ab.setFont(QFont(_MONO, _pt(8), QFont.Weight.Bold))
...
class RemoteKeyOverlay(QWidget):
    ...
    def __init__(self, url: str, key: str, auto_login_url: str = "",
        ...
        self._url_lbl.setFont(QFont(_MONO, _pt(8)))
        ...
        self._key_lbl.setFont(QFont(_MONO, _pt(28), QFont.Weight.Bold))
        ...
        self._timer_lbl.setFont(QFont(_MONO, _pt(8)))
        ...
        new_btn.setFont(QFont(_MONO, _pt(8), QFont.Weight.Bold))
        ...
        close_btn.setFont(QFont(_MONO, _pt(8), QFont.Weight.Bold))
        close_btn.setCursor(Qt.CursorShape.PointingHandCursor)
        close_btn.setStyleSheet(f"""
            QPushButton {{
                background: transparent; color: {C.TEXT_MED};
    ...
    def _update_qr(self, url: str) -> None:
        ...
        try:
            ...
            self._qr_label.setFont(QFont(_MONO, _pt(8)))
            self._qr_label.setStyleSheet(
                "color: #888; background: white; border-radius: 10px; padding: 4px;"
            )
        except Exception:
            self._qr_label.setText(url[:28])
            self._qr_label.setFont(QFont(_MONO, _pt(7)))
            self._qr_label.setStyleSheet(
    ...
    def mark_connected(self) -> None:
        ...
        """)
        self._qr_label.setText("✓")
        self._qr_label.setFont(QFont(_MONO, _pt(54), QFont.Weight.Bold))
        self._qr_label.setStyleSheet(
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        ...
        _cam_title.setFont(QFont(_MONO, _pt(8), QFont.Weight.Bold))
        _cam_title.setStyleSheet(f"color: {C.PRI}; background: transparent;")
        _cam_hdr.addWidget(_cam_title)
        _cam_hdr.addStretch()
        _cam_x = QPushButton("✕  CLOSE")
        _cam_x.setFont(QFont(_MONO, _pt(8), QFont.Weight.Bold))
    ...
    def _build_header(self) -> QWidget:
        ...
        self._drawer_btn.setFont(QFont(_MONO, _pt(11)))
        ...
        self._title_lbl.setFont(QFont(_MONO, _pt(17), QFont.Weight.Bold))
        ...
        self._sub_lbl.setFont(QFont(_MONO, _pt(7)))
        ...
        self._clock_lbl.setFont(QFont(_MONO, _pt(14), QFont.Weight.Bold))
        self._clock_lbl.setStyleSheet(f"color: {C.PRI}; background: transparent;")
        self._clock_lbl.setAlignment(Qt.AlignmentFlag.AlignRight)
        right_col.addWidget(self._clock_lbl)
        self._date_lbl = QLabel("")
        self._date_lbl.setFont(QFont(_MONO, _pt(7)))
    ...
    def _build_left_panel(self) -> QWidget:
        ...
        hdr.setFont(QFont(_MONO, _pt(7), QFont.Weight.Bold))
        hdr.setStyleSheet(f"color: {C.PRI}; background: transparent; "
        ...
        self._uptime_lbl.setFont(QFont(_MONO, _pt(8), QFont.Weight.Bold))
        self._uptime_lbl.setStyleSheet(f"color: {C.GREEN}; background: transparent; border: none;")
        ip_lay.addWidget(self._uptime_lbl)

        self._proc_lbl = QLabel("PROC  --")
        self._proc_lbl.setFont(QFont(_MONO, _pt(8)))
        self._proc_lbl.setStyleSheet(f"color: {C.TEXT_MED}; background: transparent; border: none;")
        ip_lay.addWidget(self._proc_lbl)

        os_name = {"Windows": "WIN", "Darwin": "macOS", "Linux": "LINUX"}.get(_OS, _OS.upper())
        os_lbl = QLabel(f"OS  {os_name}")
        os_lbl.setFont(QFont(_MONO, _pt(8)))
        ...
        for txt, col in [
            ...
            lbl = QLabel(txt)
            lbl.setFont(QFont(_MONO, _pt(7), QFont.Weight.Bold))
    ...
    def _build_right_panel(self) -> QWidget:
        ...
        def _sec(txt):
            l = QLabel(f"▸ {txt}")
            l.setFont(QFont(_MONO, _pt(7), QFont.Weight.Bold))
        ...
        self._file_hint.setFont(QFont(_MONO, _pt(7)))
        ...
        self._interrupt_btn.setFont(QFont(_MONO, _pt(8), QFont.Weight.Bold))
        self._interrupt_btn.setCursor(Qt.CursorShape.PointingHandCursor)
        self._interrupt_btn.setStyleSheet(f"""
            QPushButton {{
                background: #2b2124; color: #f0b9be;
                border: 1px solid {C.MUTED_C}; border-radius: 6px;
            }}
            QPushButton:hover {{
                background: #35272b; border: 1px solid #eb8a93;
            }}
            QPushButton:pressed {{
                background: #402d32;
            }}
        ...
        self._mute_btn.setFixedHeight(48)
        self._mute_btn.setFont(QFont(_MONO, _pt(10), QFont.Weight.Bold))
    ...
    def _build_quick_drawer(self) -> QWidget:
        ...
        remote_btn.setFont(QFont(_MONO, _pt(8), QFont.Weight.Bold))
        ...
        fs_btn.setFont(QFont(_MONO, _pt(7)))
        ...
        sc_btn.setFont(QFont(_MONO, _pt(7)))
        ...
        self._autostart_btn.setFont(QFont(_MONO, _pt(7)))
        ...
        cust_btn.setFont(QFont(_MONO, _pt(7)))
        ...
        self._brief_btn.setFont(QFont(_MONO, _pt(7)))
        ...
        self._wake_btn.setFont(QFont(_MONO, _pt(7)))
        ...
        self._wake_sleep_btn.setFont(QFont(_MONO, _pt(7)))
        ...
        self._ptt_btn.setFont(QFont(_MONO, _pt(7)))
        ...
        self._hud_btn.setFont(QFont(_MONO, _pt(7)))
        ...
        audio_btn.setFont(QFont(_MONO, _pt(7)))
        ...
        mem_btn.setFont(QFont(_MONO, _pt(7)))
        ...
        plugin_btn.setFont(QFont(_MONO, _pt(7)))
        ...
        settings_btn.setFont(QFont(_MONO, _pt(7)))
    ...
    def _build_input_row(self) -> QHBoxLayout:
        ...
        self._input.setFont(QFont(_MONO, _pt(9)))
        ...
        send.setFont(QFont(_MONO, _pt(11), QFont.Weight.Bold))
    ...
    def _build_content_panel(self) -> QWidget:
        ...
        dot = QLabel("◈")
        dot.setFont(QFont(_MONO, _pt(9), QFont.Weight.Bold))
        dot.setStyleSheet(f"color: {C.PRI}; background: transparent;")
        hdr.addWidget(dot)

        self._content_title_lbl = QLabel("BRIEFING")
        self._content_title_lbl.setFont(QFont(_MONO, _pt(8), QFont.Weight.Bold))
        ...
        self._content_ts_lbl.setFont(QFont(_MONO, _pt(7)))
        self._content_ts_lbl.setStyleSheet(f"color: {C.TEXT_DIM}; background: transparent;")
        hdr.addWidget(self._content_ts_lbl)

        dismiss = QPushButton("DISMISS  ✕")
        dismiss.setFont(QFont(_MONO, _pt(7)))
        ...
        self._content_display.setFont(QFont(_MONO, _pt(8)))
    ...
    def _show_review(self, title: str, summary: str, findings, unclear):
        ...
        e = self._esc
        parts = [f'<div style="color:{C.TEXT}; font-family:{_MONO};">']
    ...
    def _build_quiz_panel(self) -> QWidget:
        ...
        self._quiz_title_lbl.setFont(QFont(_MONO, _pt(8), QFont.Weight.Bold))
        ...
        self._quiz_count_lbl.setFont(QFont(_MONO, _pt(7)))
        ...
        quit_btn.setFont(QFont(_MONO, _pt(7)))
        ...
        self._quiz_q_lbl.setFont(QFont(_MONO, _pt(9)))
        ...
        self._quiz_note_lbl.setFont(QFont(_MONO, _pt(8)))
    ...
    def _quiz_render(self):
        ...
        if opts:
            ...
            field = QLineEdit()
            field.setFont(QFont(_MONO, _pt(9)))
    ...
    def _build_footer(self) -> QWidget:
        ...
        def _fl(txt, color=C.TEXT_MED):
            l = QLabel(txt); l.setFont(QFont(_MONO, _pt(7)))
            l.setStyleSheet(f"color: {color}; background: transparent;")
            return l
    ...
    def _style_mute_btn(self):
        if self._muted:
            ...
            self._mute_btn.setStyleSheet(f"""
                QPushButton {{
                    background: #3a2226; color: #f2c4c8;
                    border: 1px solid {C.MUTED_C}; border-radius: 8px;
                }}
                QPushButton:hover {{ background: #45282d; }}
            """)
        else:
            self._mute_btn.setText("🎙  MICROPHONE ACTIVE")
            self._mute_btn.setStyleSheet(f"""
                QPushButton {{
                    background: #1f3a33; color: #bfe6d8;
                    border: 1px solid {C.GREEN_D}; border-radius: 8px;
                }}
                QPushButton:hover {{ background: #25453d; }}
            """)
